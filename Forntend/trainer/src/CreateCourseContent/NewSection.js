...
{/* Adding New Section */}
      ...
      {!isAddingSection && (
            <button className='new-btn' onClick={() => setIsAddingSection(true)}>
              <FaPlus id='icon' />Section</button>
          )}
        {isAddingSection && (
