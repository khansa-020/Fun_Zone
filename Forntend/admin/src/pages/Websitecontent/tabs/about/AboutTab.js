    ...
    <>
      <div className={style.container} style={{height:window.innerHeight}}>
        ...
        <div className={style.author}>
          <Aboutus
            heading="Qoute"
            text="development course is dolor sit amet, consectetur adipisicing elit. Ut eos, eum recusandae ratione odit earum quaerat assumenda magnam itaque et tempora necessitatibus consectetur a deleniti modi repellat labore q dolore ."
            author="Qoute by"
            img={"https://picsum.photos/seed/picsum/200/300"}
          />
        </div>
